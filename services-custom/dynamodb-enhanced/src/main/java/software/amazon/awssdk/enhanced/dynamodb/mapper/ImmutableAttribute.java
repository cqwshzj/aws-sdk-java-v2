...
/**
 * A class that represents an attribute on an mapped immutable item. An {@link ImmutableTableSchema} composes multiple
 * attributes that map to a common immutable item class.
 * <p>
