...
public final class ResolvedImmutableAttribute<T, B> {
    ...
    public static <T, B, R> ResolvedImmutableAttribute<T, B> create(ImmutableAttribute<T, B, R> immutableAttribute,
        ...
        BiConsumer<B, AttributeValue> updateBuilderWithTransform = (builder, attributeValue) -> {
    ...
    public <T1, B1> ResolvedImmutableAttribute<T1, B1> transform(Function<T1, T> transformItem,
